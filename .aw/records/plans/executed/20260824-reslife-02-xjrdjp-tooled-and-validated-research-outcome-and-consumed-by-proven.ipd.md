...
## Workflow history
- 2026-08-25 executed (opencode its_direct/pt3-claude-opus-4.8-1m-us): Tooled+validated research provenance: set-outcome verb + in-place frontmatter updater (round-trip), consumed_by carried in INDEX.json (regenerated), and dangling-consumed-by (cross-tree resolve) + adopted-without-consumer drift rules; all E performed, all V pass with pasted test evidence
