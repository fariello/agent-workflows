...
## Workflow history
- 2026-09-01 executed (opencode/its_direct/pt3-claude-opus-5-1m-us): Phase 6 (optional OS-sandbox hard-enforcement profile) shipped earlier as b08de37d plus corrections 909eb007/e5b0f939; this reconciles the lifecycle record, which still read approved in pending/ while the code was live on main. [Scope reconciliation - in-scope-unmodified agent_workflows/host_adapters.py: already landed; unmodified under this receipt; in-scope-unmodified agent_workflows/host_sandbox_profile.py: already landed in b08de37d/909eb007; unmodified under this receipt because the work predates it; in-scope-unmodified agent_workflows/oc_runipd.py: already landed (select_execution_profile/enter_sandbox imports live on main); unmodified under this receipt; in-scope-unmodified tests/test_host_sandbox_profile.py: already landed; 27 tests pass on main; unmodified under this receipt]
