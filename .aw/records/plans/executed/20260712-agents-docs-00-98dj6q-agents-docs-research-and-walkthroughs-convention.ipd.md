...
- Id: 98dj6q
- Set: agents-docs (agents docs research and walkthroughs convention)
- Order: 0
...
6. **AGENTS.md directive (this repo + installed block).** Add a short rule to the managed
   ...
   - per IPD 20260712-mirror-workflow-00-ndxj3i-mirror-workflow-pointer-into-native-agent-files - into existing CLAUDE.md/GEMINI.md.)
...
- The brain-dir MUST-mirror RULES themselves (Theme D `20260712-agent-brain-00-lhmlzo-agent-brain-dir-plan-and-walkthrough-mirroring`) - this IPD provides the
...
independent of the native-file-mirroring IPD (20260712-mirror-workflow-00-ndxj3i-mirror-workflow-pointer-into-native-agent-files) except that both touch the AGENTS.md
