...
- 2026-08-19 executed (opencode Opus 4.8): E-01..E-03 performed, V pass; board shows compact stem by default + --long for full path; full serial suite 1159 passed, 1 skipped.
...
- [x] V-01 validates E-01
  ...
  - Observed evidence: _identity_stem returns '20260815-attnview-followups-01-mc5xts' for the clustered backlog name and 'setup-repo-v1' for the action file (test_attention_stem + live).
  - Result: pass
...
- [x] V-02 validates E-02
  ...
  - Observed evidence: live `FORCE_COLOR=1 aw att` shows stems with no directory; `aw att --long` shows full paths; --format json/piped/--agent unchanged (test_attention_stem test_plain_board_unchanged + suite).
  - Result: pass
...
- [x] V-03 validates E-03
  ...
  - Observed evidence: tests/test_attention_stem.py 4 pass; awdoctor-01 compact/colored-render/priority-blocker tests updated to the stem default; full serial suite 1159 passed, 1 skipped.
  - Result: pass
