...
- Dependent: the `/handoff` IPD (20260717-agentcont-03-5twbwf-handoff-workflow-session-continuity) defaults its output to `.agents/prompts/local/` (recorded there at its execution).
