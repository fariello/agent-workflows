...
- 2026-08-18 /plan-review (opencode Opus 4.8, RIGOROUS): APPROVE. Audit-and-harden of the research surface; verified subverb list (cli.py:770) + backends; E-01 is a self-limiting audit ('confirm no source file changed'), E-02 a modest fix + test; fold decisions correctly deferred to OQ-01/awcmdsurf. No findings.
- 2026-08-18 executed (opencode Opus 4.8): E-01..E-02 performed, V pass; audited all 9 research subverbs (fold/keep table); --dir alias on new/new-comparison unsafe (positional collision) -> OQ-01, help already clear; test added; full serial suite 1147 passed 1 skipped.
...
- [x] V-01 validates E-01
  ...
  - Observed evidence: Verified: all 9 research subverbs parse+dispatch, --dir consistent on query verbs; test_research_surface 3 pass; suite 1147p/1s.
  - Result: pass
