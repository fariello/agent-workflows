...
- Scope: `agent_workflows/engine.py` `run_git_diagnostics` (state detection + the prompt/menu logic,
  ...
  `20260712-aw-install-00-ysuonq-aw-install-missing-git-diagnostics-preflight` (both are install pre-flight bugs); coordinate the two (1837-01's scope fence
...
- Id: gs65w2
- Set: git-diagnostics (git diagnostics untracked and in sync false alarm)
- Order: 0
