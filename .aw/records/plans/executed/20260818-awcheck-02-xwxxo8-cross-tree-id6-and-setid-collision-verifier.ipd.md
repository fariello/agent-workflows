...
- 2026-08-18 executed (opencode Opus 4.8): E-01..E-03 performed, V pass; check_collisions + collisions kwarg committed; 11 module tests pass.
...
- [x] V-01 validates E-01
  ...
  - Observed evidence: test_id6_collision: a plan+spec sharing id6 dup111 -> exactly one check.id6-collision.
  - Result: pass
- [x] V-02 validates E-02
  ...
  - Observed evidence: test_setid_collision: setid demo with (Alpha) vs (Beta) -> check.setid-collision; test_no_collision_clean: consistent -> none.
  - Result: pass
- [x] V-03 validates E-03
  ...
  - Observed evidence: pytest tests/test_check_engine.py -> 11 passed; test_all_runs_collisions_once confirms check_types(['all']) runs collisions exactly once. Full suite at Set boundary.
  - Result: pass
