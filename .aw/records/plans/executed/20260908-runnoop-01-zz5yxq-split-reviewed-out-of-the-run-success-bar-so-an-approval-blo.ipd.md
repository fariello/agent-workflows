...
Spec `25kzda` (`.aw/records/specs/approved/20260826-0718-01-aw-run-deterministic-run-and-verify.spec.md`, `- Status: approved`) §5.6 owns the per-item outcome vocabulary and the run exit-code table. TWO OBLIGATIONS FOLLOW.
