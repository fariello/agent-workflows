...
- Approval: approved by maintainer 2026-07-11 (all open questions OQ2-6 resolved; `aw plans` board
  ...
  board (was change #5) was split to follow-on `20260711-aw-plans-00-gwu2pv-aw-plans-status-board.md` and is
  NOT part of this execution.
- Author: opencode (its_direct/pt3-claude-opus-4.8-1m-us)
- Id: t1nlqc
- Set: plan-status (plan status vocabulary and workflow provenance)
- Order: 0
...
- 2026-07-11 executed (its_direct/pt3-claude-opus-4.8-1m-us): four batches - B1 template
  ...
  Status -> executed; git mv to executed/. Board (change #5) split to 20260711-aw-plans-00-gwu2pv-aw-plans-status-board.
