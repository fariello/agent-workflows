...
- 2026-08-18 executed (opencode Opus 4.8): awhistory Set complete: Orders 01 (sidecar store), 02 (route writers + slim inline), 03 (migration excl. plans + record-history verb) all executed; spec 20260818-1525-02 satisfied. Full serial suite 1079 passed 1 skipped.
...
- [x] V-01 validates E-01
  ...
  - Observed evidence: All three child Orders executed; global history.jsonl sidecar + routing + migration + read verb shipped; plans untouched (IPD-S405); suite 1079p/1s.
  - Result: pass
