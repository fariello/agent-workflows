...
## Workflow history
- 2026-08-28 executed (opencode its_direct/pt3-claude-opus-4.8-1m-us): Implemented spec id6-in-filename: aw specs new producer, grandfathering checker cutover (SPEC_ID6_CUTOVER_DATE=20260828), and aw rename specs --to-id6 minting conversion. Full suite 2453 passed 1 skipped; aw check all unchanged at 68 baseline; aw sanitize clean. [Scope reconciliation - in-scope-unmodified .aw/records/specs/: committed-in-fec064d; in-scope-unmodified .aw/system/workflows/setup-repo/tools/normalize_plan_names.py: committed-in-fec064d; in-scope-unmodified AGENTS.md: committed-in-fec064d; in-scope-unmodified agent_workflows/artifact_naming.py: committed-in-fec064d; in-scope-unmodified agent_workflows/artifact_rename.py: committed-in-fec064d; in-scope-unmodified agent_workflows/check_engine.py: committed-in-fec064d; in-scope-unmodified agent_workflows/cli.py: committed-in-fec064d; in-scope-unmodified agent_workflows/command_surface.py: committed-in-fec064d; in-scope-unmodified agent_workflows/specs.py: committed-in-fec064d; in-scope-unmodified tests/: committed-in-fec064d]
- 2026-08-27 approved (aw set): status set to approved
- 2026-08-27 reviewed (opencode its_direct/pt3-claude-opus-4.8-1m-us): status set to reviewed
...
- 19 of 21 specs have no id6 at all; 2 already carry `- Id:` but still use legacy filenames (the cheap pilots): the aw-run spec `25kzda` (`20260826-25kzda-01-25kzda-aw-run-deterministic-run-and-verify.spec.md`) and the research-lifecycle spec `5tapom` (`20260824-5tapom-01-5tapom-research-lifecycle-reliability.spec.md`). NOTE: `25kzda` is the aw-run spec, not the research-lifecycle spec.
