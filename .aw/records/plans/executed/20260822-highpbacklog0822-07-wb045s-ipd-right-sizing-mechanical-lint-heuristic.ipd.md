...
- 2026-08-23 executed (opencode (its_direct/pt3-claude-opus-4.8-1m-us)): E-01..E-03 executed via agy/Gemini (committed a83a663): per-E-item density heuristic in ipd_schema.py (e_item_density_advisory) + check_density in ipd_lint.py surfaced via a SEPARATE advisory channel (IPD-Z602) that does NOT feed disposition (a flagged plan stays conforming); ipd-structure spec updated; tests in test_ipd_lint.py + test_ipd_schema.py incl. false-positive-guard corpus from executed plans. opencode independently verified: heuristic is ADVISORY (aw ipd lint --all shows 0 errors; this Set's executed IPDs 02/03/06 still conforming), 4 E/4 V... actually 3E/3V pass, full suite 2046 passed 1 skipped (pytest rc=0). Closes backlog 8iy2dk part 2/2. Terminal transition to executed/.
