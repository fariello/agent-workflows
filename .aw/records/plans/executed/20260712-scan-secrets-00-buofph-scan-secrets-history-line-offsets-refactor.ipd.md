...
- Approval: approved by maintainer 2026-07-12. Executed 2026-07-12 (its_direct/pt3-claude-opus-4.8-1m-us);
  full suite green (206).
- Author: Antigravity (Gemini 1.5 Pro)
- Id: buofph
- Set: scan-secrets (scan secrets history line offsets refactor)
- Order: 0
...
- 2026-07-12 approved + executed (its_direct/pt3-claude-opus-4.8-1m-us): added `start_line` param to
  `scan_text` (default 1, safe for existing callers) and `@@`-hunk-header parsing in `scan_history`
  so history findings report the real target-file line; added `test_scan_history_reports_correct_offset`
  (secret planted at line 4 -> reported at :4, verified). Full suite green (206). Status -> executed.
