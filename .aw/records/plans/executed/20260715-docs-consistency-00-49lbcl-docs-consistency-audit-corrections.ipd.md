...
- Id: 49lbcl
- Set: docs-consistency (docs consistency audit corrections)
- Order: 0
...
- F7 (`CONDITIONAL-GO` spelling) is owned by pending IPD `20260715-unify-readiness-00-c59ziz-unify-readiness-verdict-vocabulary`; not fixed here.
...
- Independent of the agent-comms IPD line. Coordinate F7 with `20260715-unify-readiness-00-c59ziz-unify-readiness-verdict-vocabulary` (that IPD owns it).
...
1. SCOPE FENCE. Edit ONLY the specific files/lines named in F1-F6, F8-F13 (RELEASING.md, index.md,
   ...
   and a DECISIONS erratum entry. Do NOT touch F7 (owned by 20260715-unify-readiness-00-c59ziz-unify-readiness-verdict-vocabulary). Do NOT rewrite append-only
