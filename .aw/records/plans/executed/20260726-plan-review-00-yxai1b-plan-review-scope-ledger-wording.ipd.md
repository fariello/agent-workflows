...
- Id: yxai1b
- Set: plan-review (plan review scope ledger wording)
- Order: 0
...
- 2026-07-26 executed (opencode its_direct/pt3-claude-opus-4.8-1m-us): prose-only execution. Tightened `plan-review` Step 0.1 (bounded ledger = named targets + documented eligibility; defined candidate/incidental; NOT REVIEWED = skipped candidates or (none)) + both report-template NOT REVIEWED blocks; applied the same to `plan-review-long` Step 1 + report-template for parity, leaving the 'include every scope-ledger item' rule intact with a clarifying gloss. Added DECISIONS D110 + CHANGELOG. No review-logic change. Dash/leak clean; full suite unchanged at 425 passed, 1 skipped. Path-scoped commits, no push. Status: approved -> executed; moved to `.agents/plans/executed/`.
