...
- 2026-08-19 executed (agy_run.py Gemini 3.7 + opencode independent-validate): E performed (agy SUCCESS); agy added detect_split_brain_layout/describe_split_brain (engine) + _split_brain_guard wired into install (fail-safe, skips under --yes/non-TTY, never destructive) + tests + closed u298fd. opencode INDEPENDENTLY verified: guard true on split-brain, false on clean-aw/clean-legacy/cruft; split tests pass; full serial suite 1212 passed 1 skipped; u298fd done. Committed by agy at 34c051e.
