...
- Id: 2txx9b
- Set: researchprompt (research-prompt pipeline)
- Order: 2
<!--
Set-tag CORRECTION (2026-07-20, via IPD 20260717-agentcont-01-6a3myl-whatnext-surveyor-workflow Step 5): this plan was originally
...
|------------|------------------|------|--------|------------------------|
| n/a | Medium | functionality | The `/whatnext` (surveyor), `/research` (producer), and `/handoff` (generator) workflows that CONSUME this convention. | Orders 3-5 of this Set; each its own IPD -> plan-review -> approval. `/handoff` already has IPD `20260717-agentcont-03-5twbwf-handoff-workflow-session-continuity`. |
