...
- [x] V-04 validates E-04
  ...
  - Observed evidence: RECORDED VIA `aw specs note`; status unchanged at `approved`, every byte-pinned region byte-identical, bare-suite delta empty by node id.
    ...
    ```
    $ aw specs note .aw/records/specs/approved/20260826-25kzda-01-25kzda-aw-run-deterministic-run-and-verify.spec.md --message "Factual-status correction of all three point-in-time preamble paragraphs by plan `wenmg4` ..."
