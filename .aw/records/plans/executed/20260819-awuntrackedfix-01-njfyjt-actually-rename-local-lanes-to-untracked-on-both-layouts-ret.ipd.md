...
- 2026-08-19 executed (opencode Opus 4.8): E-01..E-04 performed, V pass; local->untracked on both layouts + recursive merge + gitignore + tools-free normalize-lanes verb; proven in an installed wheel; full serial suite 1174 passed, 1 skipped.
...
- [x] V-01 validates E-01
  ...
  - Observed evidence: migrate_local_lanes_to_untracked covers both layouts via _lane_bases; a fixture with local/ under .aw/records/comms AND .agents/prompts renames both to untracked/, second call returns [] (test_untracked_lane_both_layouts).
  - Result: pass
...
- [x] V-02 validates E-02
  ...
  - Observed evidence: PR-002 fixed: recursive _merge_tree moves a NESTED local/acks/x.json into a pre-existing empty untracked/acks/ (not stranded); scaffold now migrates BEFORE mkdir; _ensure_untracked_gitignore writes/rewrites untracked/ in each base (test_untracked_lane_both_layouts test_pr002_nested_merge_when_untracked_preexists + gitignore assert).
  - Result: pass
...
- [x] V-03 validates E-03
  ...
  - Observed evidence: New tools-free `aw normalize-lanes` verb: PROVEN in a clean pip-installed wheel - `aw normalize-lanes` renamed .aw/records/comms/local -> untracked/ (nested acks/x.json preserved) AND .agents/prompts/local -> untracked/ (note.md intact), EXIT 0, NO ModuleNotFoundError: tools. NOT routed through migrate-layout (PR-001/revnjq).
  - Result: pass
...
- [x] V-04 validates E-04
  ...
  - Observed evidence: This repo: `find . -type d -iname local` (excl node_modules/tmp) returns NOTHING; all four bases have untracked/ + a .gitignore containing untracked/; test_untracked_lane_both_layouts (3) + test_untracked_lane_migration green; installed-wheel proof pasted above; full serial suite 1174 passed, 1 skipped.
  - Result: pass
