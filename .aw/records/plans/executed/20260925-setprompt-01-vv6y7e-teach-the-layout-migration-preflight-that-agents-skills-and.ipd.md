...
- [x] V-01 validates E-01
  ...
  - Observed evidence: Measured at executing HEAD on four scratch repos: BASE alone dry run OK (is_valid=True); BASE + skills PreflightGateError: Migration plan invalid: [{'rule': 'unknown-owner', 'detail': 'agents:skills has unknown owner/disposition', 'item_id': 'ac33475bcf2ac7b9d2a43f085642b2b2931c1051fca966d054e63676727303eb'}, {'rule': 'unknown-owner', 'detail': 'agents:skills/assess has unknown owner/disposition', 'item_id': '45622e2e6c85fbea7136ae3bc44b073ce2e7f9a3c65ad3972da356d9d1b5e81d'}, {'rule': 'unknown-owner', 'detail': 'agents:skills/assess/SKILL.md has unknown owner/disposition', 'item_id': '1a8dace01ff1f1c8cdbd2cd8ab12f60a5f5a65b49f030afee0383cf5bcceb5f4'}]; BASE + .aw/.gitignore PreflightGateError: Migration plan invalid: [{'rule': 'unknown-owner', 'detail': 'partial-aw:.gitignore has unknown owner/disposition', 'item_id': 'bd5af5ddd6a897092f9fe155948ef2fa7f675cfed496ac1de398c3dec564e2a0'}]; BASE + .aw/setup-repo-needed.md PreflightGateError: Migration plan invalid: [{'rule': 'unknown-owner', 'detail': 'partial-aw:setup-repo-needed.md has unknown owner/disposition', 'item_id': '76ee7c7549d7b0fa4186039e6602c5d943f84d8cafd6a7e325de40148e9d09bf'}]. classify_item('agents', 'skills/assess/SKILL.md') -> {'ownership': 'unknown', 'lifecycle_class': 'review-required', 'expected_destination_class': 'unknown', 'disposition': 'block-unknown'}; classify_item('partial-aw', '.gitignore') -> {'ownership': 'unknown', 'lifecycle_class': 'review-required', 'expected_destination_class': 'unknown', 'disposition': 'block-unknown'}; classify_item('partial-aw', 'setup-repo-needed.md') -> {'ownership': 'unknown', 'lifecycle_class': 'review-required', 'expected_destination_class': 'unknown', 'disposition': 'block-unknown'}.
  - Result: pass
...
- [x] V-02 validates E-02
  ...
  - Observed evidence: Diff: `+ from agent_workflows import engine as _engine; skills_dir_name = _engine.SKILLS_DIR.replace("\\", "/").strip("/").removeprefix(".agents").strip("/"); if first == skills_dir_name: return {"ownership": "host-adapter-candidate", "lifecycle_class": "host-adapter-candidate", "expected_destination_class": "host-adapter-in-place", "disposition": "preserve"}`. classify_item("agents", "skills/assess/SKILL.md") -> {'ownership': 'host-adapter-candidate', 'lifecycle_class': 'host-adapter-candidate', 'expected_destination_class': 'host-adapter-in-place', 'disposition': 'preserve'}. Dry run: BASE + skills: OK (dry-run): is_valid=True.
  - Result: pass
...
- [x] V-03 validates E-03
  ...
  - Observed evidence: Diff: added posix == ".gitignore" and posix == marker_rel branches returning disposition: skip and ownership: system. Confirmed in build_migration_map (if item.get("disposition") == "skip": continue), inventory (only unknown-owner or block-unknown produces error), and _handle_leftovers (_LEGACY_LEFTOVER_ROOTS = ('.agents', 'workflow-artifacts'), omitting .aw). classify_item for .gitignore and setup-repo-needed.md -> disposition: skip; both dry runs succeeded (is_valid=True).
  - Result: pass
...
- [x] V-04 validates E-04
  ...
  - Observed evidence: python3 -m pytest tests/test_layout_inventory.py -o addopts="" -q: 6 passed in 0.57s. Reverted E-02 and E-03: FAILED cases 1, 2, 3, 4, 6; PASSED case 5 (5 failed, 1 passed in 0.39s). Restored: 6 passed in 1.21s.
  - Result: pass
...
- [x] V-05 validates E-05
  ...
  - Observed evidence: Confirmed .aw/records/backlog/graduated/20260923-72qlya-01-72qlya-migrate-layout-refuses-agents-skills.backlog.md: Status: graduated; History: '- 2026-09-25 graduated (aw set): graduated into setprompt: vv6y7e fixes the classifier; je74a0 depends on it' and '- 2026-09-25 note (aw backlog): Maintainer ruling 2026-09-25 (/askme on je74a0 OQ-04): scope widened to all three refusal triggers, .agents/skills AND the partial-aw .aw/.gitignore and .aw/setup-repo-needed.md; fixed by plan vv6y7e (setprompt Order 01).' Both already present, no note write needed.
  - Result: pass
...
- [x] V-06 validates E-06
  ...
  - Observed evidence: Bare pytest before: 2356 passed, 1 skipped, 3 warnings in 61.00s (0:01:01). Bare pytest after: 2362 passed, 1 skipped, 3 warnings in 69.08s (0:01:09). After-minus-before failing node-ID set: set() (empty).
  - Result: pass
