...
- 2026-08-19 executed (opencode Opus 4.8): E-01..E-04 performed, V pass; single framework-owned .aw/.gitignore consolidates the untracked-lane ignores; comms spec rewritten; proven in an installed wheel; full serial suite 1176 passed, 1 skipped.
...
- [x] V-01 validates E-01
  ...
  - Observed evidence: fresh .aw/-layout scaffold writes repo/.aw/.gitignore with records/*/untracked/ and NO nested .aw/records/{comms,prompts}/.gitignore; legacy .agents/ scaffold keeps nested (engine _canonical_aw guard; test_setup_artifacts updated + green).
  - Result: pass
...
- [x] V-02 validates E-02
  ...
  - Observed evidence: migration on an .aw/ repo yields a single .aw/.gitignore (records/*/untracked/) and deletes stale nested .aw/records/*/gitignore; a .agents/ lane keeps its nested file; second run no-op (test_untracked_lane_both_layouts + _ensure_aw_gitignore).
  - Result: pass
...
- [x] V-03 validates E-03
  ...
  - Observed evidence: comms spec 20260715-1722-01 rewritten to the single .aw/.gitignore design (superseded note added, nothing shipped); aw specs check exit 0.
  - Result: pass
...
- [x] V-04 validates E-04
  ...
  - Observed evidence: THIS repo: one .aw/.gitignore (records/*/untracked/), nested removed from HEAD, git check-ignore covers both lanes; tests updated incl. counts 26->25; INSTALLED-WHEEL proof: fresh install + normalize-lanes produce the single file + ignore both lanes + no tools import error; full serial suite 1176 passed, 1 skipped.
  - Result: pass
