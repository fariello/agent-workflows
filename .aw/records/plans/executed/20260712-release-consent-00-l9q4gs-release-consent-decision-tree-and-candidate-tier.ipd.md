...
- Scope: `.agents/workflows/release-review/08-final-ship-review.md` (replace the binary GO handoff
  ...
  block from IPD `20260712-agent-execution-00-3obd0t-agent-execution-contract-in-pointer-block` (add "never create/push a tag, GitHub Release, or PyPI upload
...
- Id: l9q4gs
- Set: release-consent (release consent decision tree and candidate tier)
- Order: 0
...
- COORDINATE with IPD `20260712-agent-execution-00-3obd0t-agent-execution-contract-in-pointer-block` (execution-contract block): change #4 adds one line to the
