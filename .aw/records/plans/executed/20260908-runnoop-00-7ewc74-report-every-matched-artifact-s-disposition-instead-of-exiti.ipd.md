...
Spec `25kzda` (`.aw/records/specs/approved/20260826-25kzda-01-25kzda-aw-run-deterministic-run-and-verify.spec.md`, `- Status: approved`) governs this surface, and REVIEW FOUND IT MORE PRESCRIPTIVE THAN THIS PLAN ORIGINALLY STATED. The plan said §5.6 "already REQUIRES most of what this Set builds" and left the disposition's NAME to child 01 as an open choice. Both halves understate the spec.
