...
- [x] V-01 validates E-01
  ...
  - Observed evidence: Values at all 8 definition sites (with line drift noted and verified):
...
- [x] V-02 validates E-02
  ...
  - Observed evidence: Baseline commit: `git merge-base HEAD f3da906e` -> `f3da906e0714fe33a20c321e3c7f87a4f3b180eb`.
...
- [x] V-03 validates E-03
  ...
  - Observed evidence: SHAPE A reconstruction executed across both hosts (`oc_runipd` and `agy_runipd`):
...
- [x] V-04 validates E-04
  ...
  - Observed evidence: 1. SHAPE B Reconstruction:
