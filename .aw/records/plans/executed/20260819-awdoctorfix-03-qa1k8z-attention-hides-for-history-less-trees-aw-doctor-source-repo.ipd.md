...
- 2026-08-19 executed (opencode Opus 4.8): E-01..E-04 performed, V pass; ? suppressed on history-less trees, aw doctor source-repo-aware + summary; full serial suite 1171 passed, 1 skipped.
...
- [x] V-01 validates E-01
  ...
  - Observed evidence: _age_marker(None,'research')=='' and (None,'actions')=='' and (None,'backlog')=='?' (test_doctor_and_marker AgeMarkerTests); board research item no longer shows ?.
  - Result: pass
...
- [x] V-02 validates E-02
  ...
  - Observed evidence: _version_drift returns [] for a source-checkout fixture (pyproject name=agent-workflows + agent_workflows/ dir + no VERSION), flags version-not-installed for a consumer-dep fixture, and flags version-* for an installed-target VERSION mismatch (VersionDriftSourceRepoTests); live aw doctor here emits no version-* line.
  - Result: pass
...
- [x] V-03 validates E-03
  ...
  - Observed evidence: aw doctor prints 'aw doctor: N finding(s) (git: G, names: M, version: V).' and appends the informational note when findings are untracked-only (DoctorSummaryTests); exit code unchanged.
  - Result: pass
...
- [x] V-04 validates E-04
  ...
  - Observed evidence: tests/test_doctor_and_marker.py + test_doctor.py green; full serial suite 1171 passed, 1 skipped.
  - Result: pass
