...
## Workflow history
- 2026-08-28 executed (opencode its_direct/pt3-claude-opus-4.8-1m-us): Formalized the versioned policy engine (POLICY_SCHEMA_VERSION + RULE_REGISTRY + enriched Drift/finding shape), the check.ipd-draft-ready-to-review detect-and-nudge rule, and a positive plus adversarial fixture corpus. Full suite 2471 passed 1 skipped; aw check all unchanged at 68 baseline; aw sanitize clean. [Scope reconciliation - in-scope-unmodified agent_workflows/artifact_core.py: committed-in-a08a4f5; in-scope-unmodified agent_workflows/check_engine.py: committed-in-a08a4f5; in-scope-unmodified agent_workflows/cli.py: committed-in-a08a4f5; in-scope-unmodified agent_workflows/ipd_authoring.py: committed-in-a08a4f5; in-scope-unmodified agent_workflows/ipd_lint.py: committed-in-a08a4f5; in-scope-unmodified tests/: committed-in-a08a4f5]
