RETIRED 2026-07-22: superseded by subsequent capability changes (D96-D102 and the shipped work since). This documentation-reconciliation assessment predates that work and its "current capability set" basis is stale; retired to not-executed per the maintainer rather than executed. A fresh documentation assessment should be run against the current state if desired.
...
- Id: lud5t5
- Set: assess-documentation (assess documentation)
- Order: 0
