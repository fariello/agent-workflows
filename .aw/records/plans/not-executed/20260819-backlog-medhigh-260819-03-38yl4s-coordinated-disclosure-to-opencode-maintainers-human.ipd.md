RETIRED 2026-08-19: not doing the coordinated-disclosure packet as an agent task; the maintainer owns disclosure entirely (drafting + send). Retired to not-executed (deliberately decided against, no replacement). Backlog 2p6mgq stays open, human-owned.
...
- 2026-08-19 not-executed (opencode, maintainer decision): the maintainer chose not to have an agent draft the disclosure packet; retired to not-executed. 2p6mgq remains human-owned/open.
