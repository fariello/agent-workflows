...
| F-4 | The prediction demonstrably cost real work. Lanes `bzz5e6` and `f6idxs` each finalized verified work and were refused integration; both were later merged BY HAND with `git merge-tree` reporting rc=0 clean, recovering roughly $30 of agent time that the guard had stranded. | run `run-20260913T032416Z-2009920`, run `run-20260913T031521Z-1774617`, and the manual recovery merges `51cb5d7a` and `50d71d05` |
