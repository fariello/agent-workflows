...
- Carrier-Declined: SELF-CLOSING INSIDE THIS PLAN'S OWN EXECUTION (added at review, PR-002). E-02 requires the executor to CHOOSE and JUSTIFY the siting, so the decision happens during this plan's execution and is recorded in its own evidence. Both positions satisfy R8 and R9, so no obligation survives this plan; relocating the gate later would be a new change with its own plan.
