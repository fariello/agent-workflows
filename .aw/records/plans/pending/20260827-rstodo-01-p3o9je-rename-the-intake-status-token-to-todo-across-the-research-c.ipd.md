...
- [ ] E-05 In `research_cmd.py` change the two creation defaults (:189, :244) to emit `status="todo"` so newly created research docs are born `todo`.
  - Depends on: E-01
