...
- Status: approved
- Approval: Human maintainer approved immediate migration to monthly YYYYMM shards (2026-08-23)
- Set: shardmonth
- Order: 1
...
- [ ] E-02 Migrate existing on-disk weekly shards to monthly shards via `git mv`: move `.aw/records/research/archive/202607-W28/*` to `.aw/records/research/archive/202607/`, and `.aw/records/research/reference/202608-W32/*` and `.aw/records/research/reference/202608-W33/*` to `.aw/records/research/reference/202608/`. Remove empty weekly directories. Correct frontmatter `created: 20260101` placeholders in `20260726-skills-00-vdz4ui-codex-cli-gpt-5.findings.md` (`created: 20260726`) and `20260807-codexfit-00-qcxc6c-codex-cli-gpt-5.findings.md` (`created: 20260807`).
  - Depends on: E-01
...
- [ ] E-03 Update consumers in `agent_workflows/plans_archive.py`, `agent_workflows/research_archive.py`, `agent_workflows/plans_index.py`, `agent_workflows/engine.py`, and `agent_workflows/cli.py` to reference monthly `YYYYMM` shards in docstrings, error messages, and scaffolding.
  - Depends on: E-01
