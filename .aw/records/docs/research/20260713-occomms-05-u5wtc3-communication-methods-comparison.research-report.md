...
A core protocol could add authenticated local instance registration, durable inboxes, peer-message provenance, capability-scoped submission, and explicit task lifecycle events. See [20260713-occomms-08-wz8x3l-core-enhancement-proposal.research-report.md](20260713-occomms-08-wz8x3l-core-enhancement-proposal.research-report.md).
