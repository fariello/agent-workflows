...
id: jd8qhs
created: 20260712
set: agent-instruction-file-discovery-prompt
order: 00
topic: []
model: 
...
summary: Migrated from 20260712-agent-instruction-file-discovery-prompt-00-jd8qhs-agent-instruction-file-discovery-prompt.research-prompt.md.
consumed-by: []
---
