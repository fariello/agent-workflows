...
id: g5vhpz
created: 20260712
set: agent-instruction-file-discovery-survey-prompt
order: 00
topic: []
model: 
...
summary: Migrated from 20260712-agent-instruction-file-discovery-survey-prompt-00-g5vhpz-agent-instruction-file-discovery-survey-prompt.research-prompt.md.
consumed-by: []
---
