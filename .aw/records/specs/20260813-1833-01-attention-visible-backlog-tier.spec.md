...
- 2026-08-13 reviewed (aw specs): /plan-review complete (opencode Opus 4.8): APPROVE WITH REVISIONS APPLIED; PR-001..PR-005 fixed, all OQs resolved. to-review -> reviewed.
- 2026-08-15 approved (aw specs, --by-human): Approved by the human maintainer (via chat); approval was intended at review time but the old TTY --yes-i-am-human friction blocked recording it. Feature already built + executed (IPD crv40v).
- 2026-08-15 implementing (aw specs): Implemented via IPD crv40v (executed/); aw backlog + .agents/backlog tree + attention mapping shipped 2649d68.
- 2026-08-15 implemented (aw specs): Attention-visible backlog tier shipped: aw backlog new|set|check, .agents/backlog/{open,blocked,parked,done}, _BACKLOG_MAP into aw attention, aw att alias. Per executed IPD crv40v.
