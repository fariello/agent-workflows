...
## Workflow history
- 2026-09-26 superseded (aw set): Superseded 2026-09-26 by maintainer decision: no prompt-purity gate; the prompt-writing instructions in AGENTS.md and the /research-prompt workflow are the chosen control. No replacement spec.
