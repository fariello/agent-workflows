...
## Workflow history
- 2026-09-26 graduated (aw set): Graduated 2026-09-26 into plan 2a6phj (Set closescope), re-verified live at HEAD.
- 2026-09-26 note (aw backlog): Maintainer ruling 2026-09-26 (/askme during batch graduation): a HANDOFF may close a release-blocking item done only when the citing plan is EXECUTED; before that the item stays graduated. Implement in check_engine.evaluate_blocking_close and amend the AGENTS.md close rule.
