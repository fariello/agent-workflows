...
WHERE: agent_workflows/runner_shared.py, the 'THE PRE-WORK SUITE BASELINE (integearn-05, `9lyg5h`)' banner; and .aw/records/specs/20260826-0718-01-aw-run-deterministic-run-and-verify.spec.md section 5.1 'THE HONEST LIMIT'.
