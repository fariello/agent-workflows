...
## Workflow history
- 2026-09-23 note (aw backlog): RE-MEASURED 2026-09-23 at HEAD 0823163b while executing m7gvuz: the debt did NOT converge and its membership changed in BOTH directions. Population is now ELEVEN pending Kind: orchestrator plans, not ten. LEFT the set: lyo1tz reached executed (retired by aw oc run today, commit message 'Its own E-*/V-* items were NOT performed', all three E and V items still pending; its items are confirmation-only orchestration and backlog cnwy8g did reach done, so that retirement lost no deliverable and the gate would have CLEARED it). JOINED the set: 2xz59a (9 items, all 'Confirm child NN reached executed', orchestration-only), d1u4sy (5 items, all 'CONFIRM <id6> REACHED executed', orchestration-only), and s0gnha, which adds a NEW instance of uncovered work: its E-03 transitions the two SOURCE BACKLOG ITEMS and self-declares as 'the one substantive act that belongs on this plan because it is a Set-level record change no child owns'. CURRENT UNAMBIGUOUS SET (5): 5e4sb6, wfjsp4, a5wdne, tb63qv, s0gnha. BORDERLINE (2): ao1rb7 E-03, y9s4vm E-03. The previously-listed lyo1tz E-03 is resolved by its retirement. So the remedy is unchanged (author a child per uncovered item) but the list must be re-derived, not read from either snapshot.
