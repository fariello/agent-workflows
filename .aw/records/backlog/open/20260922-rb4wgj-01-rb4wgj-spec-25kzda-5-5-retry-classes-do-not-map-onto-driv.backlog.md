...
WHERE. `.aw/records/specs/20260826-0718-01-aw-run-deterministic-run-and-verify.spec.md` section 5.5; consumers `runner_shared.finalize_retry_decision` and `runner_shared.turn_retry_decision`/`TURN_RETRY_CLASSIFICATION`.
