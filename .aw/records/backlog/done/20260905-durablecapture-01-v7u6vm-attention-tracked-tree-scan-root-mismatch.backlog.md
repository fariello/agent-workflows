...
## Workflow history
- 2026-09-18 set (aw backlog): closed by aw oc run: IPD m867ox executed (every IPD carrier is executed and this run executed .aw/records/plans/executed/20260908-durablecapture-02-m867ox-scan-the-releases-tree-the-attention-contract-already-declar.ipd.md); evidence .aw/records/plans/executed/20260908-durablecapture-02-m867ox-scan-the-releases-tree-the-attention-contract-already-declar.ipd.md
