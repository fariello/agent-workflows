...
## Workflow history
- 2026-08-24 done (aw set): Fixed: aw ipd set approved now writes the required Approval field (status_set.py); regression tests added; all 22 previously-approved IPDs back-filled; aw check plans conforms.
