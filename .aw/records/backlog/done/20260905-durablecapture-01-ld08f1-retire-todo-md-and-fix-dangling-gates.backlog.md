...
## Workflow history
- 2026-09-18 set (aw backlog): closed by aw oc run: IPD diof9n executed (every IPD carrier is executed and this run executed .aw/records/plans/executed/20260908-durablecapture-03-diof9n-close-the-todo-md-trap-so-work-written-there-cannot-vanish-a.ipd.md); evidence .aw/records/plans/executed/20260908-durablecapture-03-diof9n-close-the-todo-md-trap-so-work-written-there-cannot-vanish-a.ipd.md
