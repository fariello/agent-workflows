...
## Workflow history
- 2026-09-26 set (aw backlog): closed by aw oc run: IPD vv6y7e executed (every IPD carrier is executed and this run executed .aw/records/plans/executed/20260925-setprompt-01-vv6y7e-teach-the-layout-migration-preflight-that-agents-skills-and.ipd.md); evidence .aw/records/plans/executed/20260925-setprompt-01-vv6y7e-teach-the-layout-migration-preflight-that-agents-skills-and.ipd.md
