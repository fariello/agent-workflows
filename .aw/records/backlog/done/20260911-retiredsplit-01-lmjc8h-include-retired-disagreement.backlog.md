...
## Workflow history
- 2026-09-25 set (aw backlog): closed by aw oc run: IPD t0jyb2 executed (every IPD carrier is executed and this run executed .aw/records/plans/executed/20260924-collpop-01-t0jyb2-make-aw-check-and-aw-doctor-report-one-collision-population.ipd.md); evidence .aw/records/plans/executed/20260924-collpop-01-t0jyb2-make-aw-check-and-aw-doctor-report-one-collision-population.ipd.md
- 2026-09-25 graduated (aw set): graduated into collpop plan t0jyb2 (to-review)
