...
## Workflow history
- 2026-09-25 set (aw backlog): closed by aw oc run: IPD 5e3nj2 executed (every IPD carrier is executed and this run executed .aw/records/plans/executed/20260924-resstatus-01-5e3nj2-split-research-pipeline-position-from-shelf-status-so-a-prom.ipd.md); evidence .aw/records/plans/executed/20260924-resstatus-01-5e3nj2-split-research-pipeline-position-from-shelf-status-so-a-prom.ipd.md
