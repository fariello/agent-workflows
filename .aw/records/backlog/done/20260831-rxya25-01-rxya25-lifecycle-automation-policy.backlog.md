...
## Workflow history
- 2026-09-20 set (aw backlog): closed by aw oc run: IPD u06zo2 executed (every IPD carrier is executed and this run executed .aw/records/plans/executed/20260908-lcpolicy-01-u06zo2-specify-the-lifecycle-automation-policy-before-any-verb-impl.ipd.md); evidence .aw/records/plans/executed/20260908-lcpolicy-01-u06zo2-specify-the-lifecycle-automation-policy-before-any-verb-impl.ipd.md
