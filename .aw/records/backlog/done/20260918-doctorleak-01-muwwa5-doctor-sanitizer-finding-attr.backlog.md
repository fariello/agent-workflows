...
## Workflow history
- 2026-09-26 set (aw backlog): closed by aw oc run: IPD rpqv4q executed (every IPD carrier is executed and this run executed .aw/records/plans/executed/20260925-doctorleak-01-rpqv4q-make-aw-doctor-report-a-found-leak-instead-of-a-probe-crash.ipd.md); evidence .aw/records/plans/executed/20260925-doctorleak-01-rpqv4q-make-aw-doctor-report-a-found-leak-instead-of-a-probe-crash.ipd.md
