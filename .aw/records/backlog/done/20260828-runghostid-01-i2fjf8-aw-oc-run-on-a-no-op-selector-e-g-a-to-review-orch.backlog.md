...
## Workflow history
- 2026-09-22 set (aw backlog): closed by aw oc run: IPD zyw4n3 executed (every IPD carrier is executed and this run executed .aw/records/plans/executed/20260908-runghostid-01-zyw4n3-emit-a-refusal-record-when-an-orchestrator-is-deferred-so-a.ipd.md); evidence .aw/records/plans/executed/20260908-runghostid-01-zyw4n3-emit-a-refusal-record-when-an-orchestrator-is-deferred-so-a.ipd.md
