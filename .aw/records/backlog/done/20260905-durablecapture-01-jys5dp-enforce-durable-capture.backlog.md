...
## Workflow history
- 2026-09-18 set (aw backlog): closed by aw oc run: IPD rnkqrc executed (every IPD carrier is executed and this run executed .aw/records/plans/executed/20260907-durablecapture-01-rnkqrc-require-a-durable-carrier-for-an-unfixed-defect-an-ipd-names.ipd.md); evidence .aw/records/plans/executed/20260907-durablecapture-01-rnkqrc-require-a-durable-carrier-for-an-unfixed-defect-an-ipd-names.ipd.md
