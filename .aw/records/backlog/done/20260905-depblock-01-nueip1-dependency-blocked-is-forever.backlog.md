...
## Workflow history
- 2026-09-21 set (aw backlog): closed by aw oc run: IPD akzy45 executed (every IPD carrier is executed and this run executed .aw/records/plans/executed/20260908-depblock-01-akzy45-distinguish-not-ready-yet-from-can-never-be-ready-so-a-trans.ipd.md); evidence .aw/records/plans/executed/20260908-depblock-01-akzy45-distinguish-not-ready-yet-from-can-never-be-ready-so-a-trans.ipd.md
