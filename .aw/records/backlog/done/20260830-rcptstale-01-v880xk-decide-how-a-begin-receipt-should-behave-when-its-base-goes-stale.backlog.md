...
## Workflow history
- 2026-09-22 set (aw backlog): closed by aw oc run: IPD wmnmei executed (every IPD carrier is executed and this run executed .aw/records/plans/executed/20260908-rcptstale-01-wmnmei-decide-what-a-frozen-begin-base-means-once-main-has-moved-an.ipd.md); evidence .aw/records/plans/executed/20260908-rcptstale-01-wmnmei-decide-what-a-frozen-begin-base-means-once-main-has-moved-an.ipd.md
