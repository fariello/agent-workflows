...
## Workflow history
- 2026-09-12 set (aw backlog): closed by aw oc run: IPD btot17 executed (every IPD carrier is executed and this run executed .aw/records/plans/executed/20260908-actmodel-01-btot17-decide-the-unit-a-model-attaches-to-before-building-per-acti.ipd.md); evidence .aw/records/plans/executed/20260908-actmodel-01-btot17-decide-the-unit-a-model-attaches-to-before-building-per-acti.ipd.md
