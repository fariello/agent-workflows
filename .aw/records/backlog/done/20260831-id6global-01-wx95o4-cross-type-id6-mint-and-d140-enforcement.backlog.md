...
## Workflow history
- 2026-09-20 set (aw backlog): closed by aw oc run: IPD sk7ggr executed (every IPD carrier is executed and this run executed .aw/records/plans/executed/20260908-id6integ-01-sk7ggr-mint-id6-against-the-unified-inventory-and-close-d140-s-decl.ipd.md); evidence .aw/records/plans/executed/20260908-id6integ-01-sk7ggr-mint-id6-against-the-unified-inventory-and-close-d140-s-decl.ipd.md
