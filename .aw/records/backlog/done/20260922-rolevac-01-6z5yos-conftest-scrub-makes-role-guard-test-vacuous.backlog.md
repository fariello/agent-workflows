...
## Workflow history
- 2026-09-24 set (aw backlog): closed by aw oc run: IPD 8i0xa7 executed (every IPD carrier is executed and this run executed .aw/records/plans/executed/20260923-rolevac-01-8i0xa7-make-the-worker-role-guard-test-able-to-fail-again-after-the.ipd.md); evidence .aw/records/plans/executed/20260923-rolevac-01-8i0xa7-make-the-worker-role-guard-test-able-to-fail-again-after-the.ipd.md
