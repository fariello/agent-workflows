...
## Workflow history
- 2026-09-25 done (aw set): OBSOLETE at 877545fc, closed during graduate-top10 triage: fixed: /state/ and /config/local.json ignored (engine.py gitignore block + backfill)
