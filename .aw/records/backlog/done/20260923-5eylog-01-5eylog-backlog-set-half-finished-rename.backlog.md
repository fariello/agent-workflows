...
## Workflow history
- 2026-09-26 done (aw set): Retired DONE (verified 2026-09-26 at 2f77995d): reproduced aw backlog set done in a scratch repo -> one rename commit, clean index. Fixed by 26519096 (git_commit_helper._staged_paths reports both rename sides; test_staged_rename_moves_and_duplicate_prevention) and f2b737e2 (r9uvwc: status_set adds the source path to touched_paths).
