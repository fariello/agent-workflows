...
## Workflow history
- 2026-09-20 set (aw backlog): closed by aw oc run: IPD i4c0c3 executed (every IPD carrier is executed and this run executed .aw/records/plans/executed/20260908-gatejrnl-01-i4c0c3-stop-the-executed-transition-gate-firing-on-a-follow-up-edit.ipd.md); evidence .aw/records/plans/executed/20260908-gatejrnl-01-i4c0c3-stop-the-executed-transition-gate-firing-on-a-follow-up-edit.ipd.md
