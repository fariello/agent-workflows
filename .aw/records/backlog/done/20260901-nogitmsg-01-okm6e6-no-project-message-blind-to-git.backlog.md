...
## Workflow history
- 2026-09-21 set (aw backlog): closed by aw oc run: IPD quqyc4 executed (every IPD carrier is executed and this run executed .aw/records/plans/executed/20260908-nogitmsg-01-quqyc4-offer-the-install-when-the-no-project-message-lands-in-a-git.ipd.md); evidence .aw/records/plans/executed/20260908-nogitmsg-01-quqyc4-offer-the-install-when-the-no-project-message-lands-in-a-git.ipd.md
