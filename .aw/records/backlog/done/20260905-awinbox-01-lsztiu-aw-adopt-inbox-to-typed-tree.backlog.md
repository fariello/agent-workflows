...
## Workflow history
- 2026-09-13 set (aw backlog): closed by aw oc run: IPD lznpv6 executed (every IPD carrier is executed and this run executed .aw/records/plans/executed/20260908-awinbox-01-lznpv6-add-aw-adopt-to-file-a-raw-inbox-drop-into-a-typed-records-t.ipd.md); evidence .aw/records/plans/executed/20260908-awinbox-01-lznpv6-add-aw-adopt-to-file-a-raw-inbox-drop-into-a-typed-records-t.ipd.md
