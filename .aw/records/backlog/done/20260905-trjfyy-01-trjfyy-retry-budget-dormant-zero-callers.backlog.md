...
## Workflow history
- 2026-09-22 set (aw backlog): closed by aw oc run: IPD xipfy1 executed (every IPD carrier is executed and this run executed .aw/records/plans/executed/20260908-retrywire-01-xipfy1-spend-the-frozen-retry-budget-on-a-retryable-failure-so-the.ipd.md); evidence .aw/records/plans/executed/20260908-retrywire-01-xipfy1-spend-the-frozen-retry-budget-on-a-retryable-failure-so-the.ipd.md
