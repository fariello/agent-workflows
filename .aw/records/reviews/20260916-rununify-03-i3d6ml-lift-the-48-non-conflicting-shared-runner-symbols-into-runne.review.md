...
| ID | Severity | Scope | Area | Evidence | Finding | Remediation Risk | Decision | Resolution |
|----|----------|-------|------|----------|---------|------------------|----------|------------|
| PR-001 | BLOCKER | IN-SCOPE | round 1 finding, discharged by directive | this plan's resolved `OQ-03`; the maintainer's 2026-09-16 directive | The 48-symbol scope was measured unachievable: only 9 symbols are liftable today, 15 need a precursor move, 6 need a sibling's symbol, 11 must not move. | C:Low; U:Low; S:Low; F:Low; Overall:Low | FIXED | The maintainer ruled 2026-09-16 that the objective is 100% de-duplication by the end of the Set, so the deferral this finding recommended is refused and the precursor work (groups E, F, H) is IN SCOPE for this plan rather than a later child. The maintainer additionally ruled that de-duplicating many symbols together before testing is permitted, which dissolves the sibling-coupling half of the finding. Recorded in this plan's resolved OQ-03. |
| PR-004 | HIGH | IN-SCOPE | round 1 finding, discharged by directive | this plan's resolved `OQ-03`; the maintainer's 2026-09-16 directive | The plan promised a lift it could not deliver, so its own scope statement was false. | C:Low; U:Low; S:Low; F:Low; Overall:Low | FIXED | Superseded by the same ruling: the scope statement is now the full sweep toward 100%, with the 11 wrapper/`global` exclusions documented as the single stated exception and E-04 required to explain why an excluded symbol is not redundancy. See the resolved OQ-03. |
