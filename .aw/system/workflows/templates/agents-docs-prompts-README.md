...
with the workflows, and not the current spec. When a prompt has a maintained successor, prefer the
workflow; the prompt is retained to show provenance and for direct copy-paste use in a tool that has
no workflow installed. They keep their historical filenames (not the dated convention).
