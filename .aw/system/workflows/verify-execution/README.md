...
any gap EMITS a corrective IPD into `.aw/records/plans/pending/` (it never fixes code in place, and
...
`.aw/system/workflows/verify-execution/verify-execution.md`" against a named executed plan.
