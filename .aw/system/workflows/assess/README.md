...
any agent: "read and execute `.aw/system/workflows/assess/assess.md`" with the concern. Bare
`/assess` lists the available concerns. See `.aw/system/workflows/index.md` for the full
catalog.
