...
_ARTIFACT_TYPE_FACETS = ("ipd", "prompt", "spec", "walkthrough", "roadmap", "backlog", "comms", "release", "review", "other")
...
def _framework_version() -> str:
    ...
    version_path = (
        _tool_root / "VERSION"
        if (_tool_root / "VERSION").is_file()
        else _tool_root.parent / "VERSION"
    )
    try:
