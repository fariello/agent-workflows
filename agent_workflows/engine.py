...
def agents_pointer_prose(target_layout: str = "legacy") -> str:
    ...
    return (
        ...
        "`aw host capabilities` reports as REFUSED for the action class, or a REFUSED orchestrator "
        "retirement with the reason the run recorded. Do NOT raise file overlap, queue order, or an "
        ...
        "plan that no child covers, do NOT delete it: ADD A CHILD for it. Measured 2026-09-07: 46 of "
        "130 orchestrators carry checklist items, most of them legitimate orchestration, which is why "
        "the distinction matters and why a blunt 'no items on a parent' rule is wrong."
