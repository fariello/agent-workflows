...
def agents_pointer_prose(target_layout: str = "legacy") -> str:
    ...
    return (
        ...
        "history`; an agent records human approval with `aw specs set --status approved --by-human "
        "--message ...`, an explicit attested speed bump; no TTY, no 'I am human' claim; and may "
        ...
        "`aw backlog new|set|check`) and surfaces in `aw attention` too: `open`->`ready`, gated "
