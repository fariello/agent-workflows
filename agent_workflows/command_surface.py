...
COMMAND_INVENTORY: Tuple[CommandDeclaration, ...] = (
    ...
    CommandDeclaration(
        command="oc profile validate-default",
        command_class="mutation",
        human_recipe="status",
        agent_record_kind="result",
        mutation_gate="none",
    ...
    CommandDeclaration(
        command="agy profile validate-default",
        command_class="mutation",
        human_recipe="status",
        agent_record_kind="result",
        mutation_gate="none",
    ...
    CommandDeclaration(
        ...
        mutation_gate="none",
        empty_error_renderer="shared_empty_result",
        legacy_flags=("--installed-only", "--size", "--agent", "--json"),
        exit_contract=(0, 2),
    ),
    CommandDeclaration(
        command="upgrade-test new",
        command_class="mutation",
        human_recipe="status",
        agent_record_kind="result",
        mutation_gate="none",
    ...
    CommandDeclaration(
        command="upgrade-test sandboxes",
        command_class="read",
        human_recipe="list",
        agent_record_kind="result",
        mutation_gate="none",
        empty_error_renderer="shared_empty_result",
        legacy_flags=("--root", "--agent", "--json"),
        exit_contract=(0, 2),
    ),
    CommandDeclaration(
        command="upgrade-test probe",
        command_class="read",
        human_recipe="detail",
        agent_record_kind="result",
        mutation_gate="none",
    ...
    CommandDeclaration(
        command="upgrade-test clean",
        command_class="mutation",
        human_recipe="preview",
        agent_record_kind="result",
        mutation_gate="dry_run_default",
        empty_error_renderer="renderer_boundary",
        legacy_flags=("--all", "--root", "--yes", "--agent", "--json"),
        exit_contract=(0, 1, 2),
    ),
    CommandDeclaration(
        command="completion",
