...
id: kams1a
created: 20260716
set: opencode-unauthenticated-local-server-advisory
order: 00
topic: []
model: 
kind: advisory
...
summary: Migrated from 20260716-opencode-unauthenticated-local-server-advisory-00-kams1a-opencode-unauthenticated-local-server-advisory.advisory.md.
consumed-by: []
---
