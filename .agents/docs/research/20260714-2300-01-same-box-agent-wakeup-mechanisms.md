...
- Related artifacts: `research/20260712-2133-01-filesystem-inter-project-agent-comms-concept.md`, the canonical comms spec `docs/specs/20260715-1722-01-agent-comms-convention.md` (the earlier `-2133-02-` draft has been removed), and `research/opencode/` (OpenCode inter-instance comms + runtime-artifacts references).
