...
- 2026-08-08 to-review (opencode its_direct/pt3-claude-opus-4.8-1m-us): child of Set `plans-adopter`; the identity layer for plans. Authored from spec `20260808-plansadopt-01-qkc93l-shared-artifact-core` Section 4.2 + OQ2.
...
The `ipd-spec` doc (`.agents/docs/specs/20260726-1340-01-ipd-spec.md`) is updated to document the new `- Id:` field (its grammar, that it is required, and that it is a stable citation handle). No change to `20260808-plansadopt-01-qkc93l-shared-artifact-core` (this executes it).
