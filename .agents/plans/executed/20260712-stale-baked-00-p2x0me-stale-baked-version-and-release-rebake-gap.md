...
- Scope: (X) regenerate `.agents/workflows/VERSION` to match the release version and commit it;
  ...
  Ships in the 1.2.1 patch with IPDs `20260712-aw-install-00-ysuonq-aw-install-missing-git-diagnostics-preflight` and `20260712-git-diagnostics-00-gs65w2-git-diagnostics-untracked-and-in-sync-false-alarm`.
- Status: executed
- Author: opencode (its_direct/pt3-claude-opus-4.8-1m-us)
- Id: p2x0me
- Set: stale-baked (stale baked version and release rebake gap)
- Order: 0
...
- Ships in the 1.2.1 patch with `20260712-aw-install-00-ysuonq-aw-install-missing-git-diagnostics-preflight` (CLI/`_install_all` diagnostics parity) and
  `20260712-git-diagnostics-00-gs65w2-git-diagnostics-untracked-and-in-sync-false-alarm` (diagnostics false alarm). Independent of `20260712-unify-install-00-wbr6u8-unify-install-orchestrator-single-source` (orchestrator
  unification, 1.3.0).
