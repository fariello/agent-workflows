...
- Id: lwug80
- Set: per-workflow (per workflow argument hint in command shims)
- Order: 0
...
| Item | Reason | Where |
|------|--------|-------|
| The /whatnext BEHAVIOR changes (chat-history, todowrite, 1-3 cap, save-to-TODO) | Different concern (workflow prose, not the installer). | IPD 20260721-whatnext-chat-00-wa7uiw-whatnext-chat-history-todowrite-save-to-todo |
