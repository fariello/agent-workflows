...
- Set: awphysical
- Order: 14
- Approval: 2026-08-16 human maintainer (chat) - approved IPD 14 (hnzr8v, migration move-not-copy) to execute after two independent /plan-review passes (opencode Opus 4.8 + Gemini) landed with all findings applied, OQ-01 resolved, and the controlling spec re-approved; recorded by opencode Opus 4.8. This is the foundational migration-engine fix; Orders 15/16 depend on it being terminal.
