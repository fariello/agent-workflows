...
- [ ] V-02 validates E-02 (the mechanism, specs.py --by-human)
  ...
  - Observed evidence:
  - Result: pending
- [ ] V-03 validates E-03 (the CLI surface, cli.py)
