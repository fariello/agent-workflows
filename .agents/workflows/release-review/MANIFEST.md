...
(`/assess-performance`, `/assess-security`, `/assess-secrets`, `/assess-accessibility`,
`/assess-testing`, `/assess-guiding-principles`, `/assess-compliance`, and more) that each assess one
